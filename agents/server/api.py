...
from .model import AutoXMLBase
from .exceptions import exception_handler

logger = logging.getLogger(__name__)

_server = Flask(__name__)
MODEL_CLASS = AutoXMLBase
BASIC_AUTH = None
...
def init_app(model_class, basic_auth_user=None, basic_auth_pass=None):
    ...
    if not issubclass(model_class, AutoXMLBase):
        raise ValueError('Inference class should be the subclass of ' + AutoXMLBase.__class__.__name__)
