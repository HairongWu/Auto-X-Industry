...
class OCRPipeline(): 
    def __init__(self):
        ...
        args['layout_dict_path'] = os.environ.get('layout_dict_path')
        args['rec_char_dict_path'] = os.environ.get('rec_char_dict_path')
        args['table_char_dict_path'] = os.environ.get('table_char_dict_path')
