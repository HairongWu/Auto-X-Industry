 ...
 */
@Entity
public class AutoXAgent extends Agent<AutoXAgent, AutoXProtocol, DefaultAgentLink> {
    ...
    public static final AgentDescriptor<AutoXAgent, AutoXProtocol, DefaultAgentLink> DESCRIPTOR = new AgentDescriptor<>(
        AutoXAgent.class, AutoXProtocol.class, DefaultAgentLink.class
    );

    protected AutoXAgent() {
    }

    public AutoXAgent(String name) {
        super(name);
    }

    @Override
    public AutoXProtocol getProtocolInstance() {
        return new AutoXProtocol(this);
    }
    ...
    public AutoXAgent setOption(Option value) {
