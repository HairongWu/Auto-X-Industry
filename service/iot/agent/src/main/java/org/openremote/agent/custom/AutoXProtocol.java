...
/**
 * A custom protocol that is used by the {@link AutoXAgent}; there is a one-to-one mapping between an {@link
 * AutoXAgent} {@link org.openremote.model.asset.Asset} and its' {@link org.openremote.model.asset.agent.Protocol}.
 * This example does nothing useful but is intended to show where protocol classes should be created.
 */
public class AutoXProtocol extends AbstractProtocol<AutoXAgent, DefaultAgentLink> {

    public static final String PROTOCOL_DISPLAY_NAME = "Custom";
    private static final Logger LOG = SyslogCategory.getLogger(PROTOCOL, AutoXProtocol.class);
    protected boolean running;

    public AutoXProtocol(AutoXAgent agent) {
        super(agent);
    }
