...
@Entity
public class GasSupplierAsset extends ElectricityAsset<GasSupplierAsset> {
    ...
    public static final AssetDescriptor<GasSupplierAsset> DESCRIPTOR = new AssetDescriptor<>("upload-network", "9257A9", GasSupplierAsset.class);
     ...
     */
    protected GasSupplierAsset() {
    }

    public GasSupplierAsset(String name) {
        super(name);
    }
    ...
    public GasSupplierAsset setFinancialCost(Double value) {
    ...
    public GasSupplierAsset setCarbonCost(Double value) {
    ...
    public GasSupplierAsset setCarbonImport(Double value) {
    ...
    public GasSupplierAsset setCarbonExport(Double value) {
    ...
    public GasSupplierAsset setEnergyLocal(Double value) {
    ...
    public GasSupplierAsset setEnergyRenewableShare(Double value) {
    ...
    public GasSupplierAsset setEnergySelfConsumption(Double value) {
    ...
    public GasSupplierAsset setEnergyAutarky(Double value) {
