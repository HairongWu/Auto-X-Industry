...
@Entity
public class WaterSupplierAsset extends ElectricityAsset<WaterSupplierAsset> {
    ...
    public static final AssetDescriptor<WaterSupplierAsset> DESCRIPTOR = new AssetDescriptor<>("upload-network", "9257A9", WaterSupplierAsset.class);
     ...
     */
    protected WaterSupplierAsset() {
    }

    public WaterSupplierAsset(String name) {
        super(name);
    }
    ...
    public WaterSupplierAsset setFinancialCost(Double value) {
    ...
    public WaterSupplierAsset setCarbonCost(Double value) {
    ...
    public WaterSupplierAsset setCarbonImport(Double value) {
    ...
    public WaterSupplierAsset setCarbonExport(Double value) {
    ...
    public WaterSupplierAsset setEnergyLocal(Double value) {
    ...
    public WaterSupplierAsset setEnergyRenewableShare(Double value) {
    ...
    public WaterSupplierAsset setEnergySelfConsumption(Double value) {
    ...
    public WaterSupplierAsset setEnergyAutarky(Double value) {
