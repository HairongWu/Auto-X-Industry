...
export const GenerationSet = ({ title, target, rootClass, buttonLabel }) => {
  ...
  const fetchStorages = useCallback(async () => {
    ...
    const storageTypes = await api.callApi("generationTypes", {
      params: {
        target,
      },
    });
  ...
  const showStorageFormModal = useCallback(
    (storage) => {
      const title = `Add Generation Task`;
